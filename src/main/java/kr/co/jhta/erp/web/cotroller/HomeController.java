...
public class HomeController {
	...
	public String intimeUser(@RequestParam("empNo") int employeeNo, @RequestParam("empName") String employeeName,
		@RequestParam("times") long intime) throws Exception {
	...
	public String outtimeUser(@RequestParam("empNo") int employeeNo, @RequestParam("empName") String employeeName,
		@RequestParam("times") long outtime) {
